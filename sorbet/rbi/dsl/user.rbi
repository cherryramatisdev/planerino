...
class User
  ...
  module GeneratedAssociationMethods
    # This method is created by ActiveRecord on the `User` class because it declared `has_many :month`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Month::PrivateCollectionProxy) }
    def month; end

    sig { params(value: T::Enumerable[::Month]).void }
    def month=(value); end
